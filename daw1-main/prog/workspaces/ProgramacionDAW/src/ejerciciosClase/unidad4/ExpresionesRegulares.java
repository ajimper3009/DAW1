...
public class ExpresionesRegulares {
	...
	public static void main(String[] args) {
		...
		// usuario de twitter empieza por @ y puede tener letras may/min _ y números. Y va de 4 a 15.
		String twitterUser = "@yo_mismo_1";
		String patronEj17 = "^@\\w{4,15}$";
		System.out.println(
				"Ejemplo usuario de twitter: " + twitterUser + " - Patrón: " + patronEj17 + " Resultado: " + numReal.matches(patronEj17));
		
		// validar un ISBN
		// Dos tipos, 10 o 13 caracteres
		// 13 caracteres puede aparacer juntos, con espacios o con guiones. En caso de aparecer
		// separados serán en grupos de 3-1-3-5-1. Los tres primeros son 978 o 979
		// 10 caracteres puede aparacer juntos, con espacios o con guiones. En caso de aparecer
		// separados serán en grupos de 1-3-5-1.
		String isbn10b = "0-123-12345-7";
		String isbn10 = "9781234567";
		
		String isbn13 = "978 0 123 12345 7";
		String patronEj18 = "^((978|979)?\\d{10})|((978-|979-)?\\d-\\d{3}-\\d{5}-\\d)|((978 |979 )?\\d \\d{3} \\d{5} \\d)$";
		System.out.println(
				"Ejemplo ISBN: " + isbn10 + " - Patrón: " + patronEj18 + " Resultado: " + isbn10.matches(patronEj18));
		System.out.println(
				"Ejemplo ISBN: " + isbn13 + " - Patrón: " + patronEj18 + " Resultado: " + isbn13.matches(patronEj18));
	}
